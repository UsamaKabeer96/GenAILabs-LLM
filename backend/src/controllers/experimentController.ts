...
export const experimentController = (experimentService: ExperimentService) => {
    const router = Router();
    ...
    router.post('/', async (req: Request, res: Response) => {
        try {
            ...
            const experiment = await experimentService.runExperiment(config);
    ...
    router.get('/', async (req: Request, res: Response) => {
        try {
            ...
            const experiments = await experimentService.getExperiments(limit, offset);
    ...
    router.delete('/:id', async (req: Request, res: Response) => {
        try {
            const { id } = req.params;
            const deleted = await experimentService.deleteExperiment(id);
    ...
    router.get('/search/:query', async (req: Request, res: Response) => {
        try {
            ...
            const experiments = await experimentService.searchExperiments(query, limit);
    ...
    router.get('/stats/overview', async (req: Request, res: Response) => {
        try {
            const stats = await experimentService.getExperimentStats();
    ...
    router.post('/generate-parameters', async (req: Request, res: Response) => {
        try {
            ...
            const combinations = ExperimentService.generateParameterCombinations(
